...
<body>
    <div class="container mt-5">
        <h2 class="text-center mb-4 text-primary">Business Application Details</h2>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p><strong>Amount Requested:</strong> ${{ number_format($applyNow->amount_requested, 2) }}</p>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <p><strong>Partner Name:</strong> {{ $applyNow->partner_first_name }} {{ $applyNow->partner_last_name }}</p>
                        <p><strong>Partner Phone:</strong> {{ $applyNow->partner_phone }}</p>
                        <p><strong>Partner SSN:</strong> {{ $applyNow->partner_ssn }}</p>
                    </div>
                    <div class="col-md-6">
                        <p><strong>Partner Ownership Percentage:</strong> {{ $applyNow->partner_ownership_percentage }}%</p>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p><strong>Owner Signature:</strong>
                    <img src="{{ asset('storage/'.$applyNow->owner_signature) }}" alt="Owner Signature" width="150" class="signature-image">
                </p>
                <p><strong>Partner Signature:</strong>
                    @if($applyNow->partner_signature)
                        <img src="{{ asset('storage/'.$applyNow->partner_signature) }}" alt="Partner Signature" width="150" class="signature-image">
                    @else
    ...
    <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.9.3/dist/umd/popper.min.js" integrity="sha384-KJ3o2DKtIkvYIKXbN1sw2PuR2dM6doPU5pndy8ekubBErJKozVwzI1qzRPI1M/jP" crossorigin="anonymous"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js" integrity="sha384-cYEnhwEVYquj5moTcihGGWbrdITpm94/5A7h0vF5a1aBchBJb72d6E0Wf46KN2Lk" crossorigin="anonymous"></script>
</body>
