        ...
        <form action="{{ route('apply.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    ...
                    <div>
                        <input type="radio" class="btn-check" name="business_years" id="businessYes"
                            autocomplete="off" value="yes" {{ old('business_years') == 'yes' ? 'checked' : '' }}
                            required>
                        ...
                        <input type="radio" class="btn-check" name="business_years" id="businessNo" autocomplete="off"
                            value="no" {{ old('business_years') == 'no' ? 'checked' : '' }} required>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="tel" class="form-control" id="businessPhone"
                        value="{{ old('business_phone') }}" name="business_phone" placeholder="Enter phone number"
                        required>
                </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="entity_type" value="{{ old('entity_type') }}" class="form-control"
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="owner_title" value="{{ old('owner_title') }}" class="form-control"
                        id="ownerTitle">
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="home_address" value="{{ old('home_address') }}" class="form-control"
                    id="homeAddress" placeholder="Address Line" required>
            </div>

            <div class="row mb-3">
                <div class="col-md-4">
                    <input type="text" name="home_city" value="{{ old('home_city') }}" class="form-control"
                        id="homeCity" placeholder="City" required>
                </div>

                <div class="col-md-4">
                    <select class="form-select" name="home_state" id="state" required>
                        <option selected>Select State</option>
                        <option value="1" {{ old('home_state') == '1' ? 'selected' : '' }}>State 1</option>
                        <option value="2" {{ old('home_state') == '2' ? 'selected' : '' }}>State 2</option>
                        <option value="3" {{ old('home_state') == '3' ? 'selected' : '' }}>State 3</option>
                    </select>
                    @error('home_state')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-4">
                    <input type="text" name="home_zip" value="{{ old('home_zip') }}" class="form-control"
                        id="homeZip" placeholder="Zip Code" required pattern="\d{5,10}">
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="tel" value="{{ old('cell_phone') }}" class="form-control" id="businessPhone"
                    name="cell_phone" placeholder="Enter phone number" required>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="partner_ownership_percentage"
                        value="{{ old('partner_ownership_percentage') }}" class="form-control" id="partnerOwnership"
                        min="0" max="100">
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    <select class="form-select" name="partner_state" id="state" required>
                        <option selected>Select State</option>
                        <option value="1" {{ old('partner_state') == '1' ? 'selected' : '' }}>State 1</option>
                        <option value="2" {{ old('partner_state') == '2' ? 'selected' : '' }}>State 2</option>
                        <option value="3" {{ old('partner_state') == '3' ? 'selected' : '' }}>State 3</option>
                    </select>
                    @error('partner_state')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="partner_ssn" value="{{ old('partner_ssn') }}" class="form-control"
                        id="partnerSSN">
                </div>

                <div class="col-md-6">
                    <label for="partnerDOB" class="form-label">Partner DOB</label>
                    <input type="date" name="partner_dob" value="{{ old('partner_dob') }}" class="form-control"
                        id="partnerDOB">
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                {{-- <input type="tel" name="partner_phone" value="{{ old('partner_phone') }}" class="form-control"
                    id="partnerPhone"> --}}
                <input type="tel" class="form-control" id="partnerPhone" value="{{ old('partner_phone') }}"
                    name="partner_phone" placeholder="Enter phone number" required>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="landlord" value="{{ old('landlord') }}" class="form-control"
                        id="landlord">
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" name="owner_signature_date" value="{{ old('owner_signature_date') }}"
                        class="form-control" id="ownerSignatureDate" required>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" name="partner_signature_date" value="{{ old('partner_signature_date') }}"
                        class="form-control" id="partnerSignatureDate">
                </div>
            </div>
